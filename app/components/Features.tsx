...
const features = [
  ...
  { title: "Dév. Web & API",          desc: "Applications web et interfaces métiers sur mesure, connectées à vos outils.", icon: CodeBracketIcon },
  { title: "Dév. Mobile",             desc: "Applications mobiles Android/iOS sur mesure pour usages clients ou métiers.", icon: DevicePhoneMobileIcon },
  { title: "Dév. Desktop",            desc: "Applications Windows, macOS, Linux adaptées à vos besoins métiers.", icon: ComputerDesktopIcon },
