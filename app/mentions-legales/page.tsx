            ...
            <div className="max-w-2xl mx-auto bg-white/90 rounded-2xl shadow-2xl border border-blue-100 p-8">
                ...
                <div className="text-gray-700 space-y-6 text-[15px]">
                    <div>
                        ...
                        <br />
                        <span className="font-semibold">Contact :</span> <a href="mailto:contact-unetratech@gmail.com" className="text-blue-600 underline">contact-unetratech@gmail.com</a>, +33 6 46 57 46 36
                    </div>
                    <div>
